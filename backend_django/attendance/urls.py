...
urlpatterns = [
    ...
    # Ruta específica para que un instructor vea las sesiones programadas para el día
    path('instructor-daily-sessions/', InstructorDailySessionsView.as_view(), name='instructor-daily-sessions'),
